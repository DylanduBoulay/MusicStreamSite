<?php
    ...
    private function validatePasswords($pw, $pw2) {
        ...
        //possible to expand error checking here as there is no password strength requirement or symbol requirement.


        //to check if the password is made of only numbers or letters
